...
% Example script for ExampleVid3_MangamaunuRect.avi
...
folder = fullfile(pwd, 'Example3'); 
file='ExampleVid3_MangamaunuRect.avi';
...
Type = 4; %type 1 = column, type 2 = row, type 3 = select (do a zigzag for fun), type 4 - you already have a set of points called stackxy.mat
...
playbackinterval=1; %video playback interval (every n frames)
