...
% Example script for ExampleVid2_GoldCoast-WRL.mp4
...
folder = fullfile(pwd, 'Example2'); 
file='ExampleVid2_GoldCoast-WRL.mp4';

%Frames to use
startframe=1;   %what frame do you want to start at?
endframe=250; %end frame (use 9999 if want last frame)
